...
f.write('label, filename, nodePair, NumberPacketsIn, NumberPacketsOut, packetSize, protocol, avgTimeInterval, totalFlowTime, bwdps\n')
f1.write('label, filename, nodePair,  NumberPacketsIn, NumberPacketsOut, packetSize, protocol, avgTimeInterval, totalFlowTime, bwdps\n')
def benignExec():
